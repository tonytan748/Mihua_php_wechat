...
<body class="withFoot">
    <div class="container">
    	...
    	<h6 style="text-align:center; padding-top:10px;">我的收藏</h6>
         <?php if(empty($orderList)): ?><div class="empty_container"><p>暂时收藏</p></div><?php endif; ?>
        <!-- 收藏 -->
        <div class="order_list">
        	<ul>
            	<?php if(is_array($myCollect)): $i = 0; $__LIST__ = $myCollect;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                	
                    <a class="goods_item" href="<?php echo U('detail',array('shop_id'=>$shop_id,'id'=>$vo[goods_id]));?>">
                        ...
                        <div class="info">
                            ...
                            <p class="property">
                                ...
                                <span class="orange">￥<?php echo ($vo["price"]); ?></span>
                            </p>
                        </div>
                    </a>
